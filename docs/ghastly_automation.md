...
sub-commands for manipulating and interacting with automations
...
* [ghastly automation get](ghastly_automation_get.md)	 - retrieve the configuration data for the given automation
* [ghastly automation list](ghastly_automation_list.md)	 - retrieve a list of all known automations
