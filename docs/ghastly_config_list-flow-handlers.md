## ghastly config list-flow-handlers

returns a list of flow handlers, whatever those are
...
```
ghastly config list-flow-handlers [flags]
```

### Options

```
  -h, --help   help for list-flow-handlers
```
